...
export class ProductsComponent implements OnInit {
  ...
  sortGames(event: any): void {
    ...
    this.filteredGames.sort((a, b) =>
      sortOrder === 'asc' ? a.gameName.localeCompare(b.gameName) : b.gameName.localeCompare(a.gameName) );
  }
  ...
  applyFilters(priceFilter: string = 'all'): void {
    ...
    if (this.searchQuery) {
      filtered = filtered.filter(game => game.gameName.toLowerCase().includes(this.searchQuery));
    }
